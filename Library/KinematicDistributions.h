...
void Read_GPR_pion_pp200(){
  std::ifstream infile("C:/root_v6.22.06/macros/HELIOS/Library/GPRfiles/GPR_pion_pp200.txt");
...
void Read_GPR_etapi_uni(){
  ...
  std::ifstream infile("C:/root_v6.22.06/macros/HELIOS/Library/GPRfiles/GPR_etapi_universal.txt");
